...
export class ShimmerLoadDataExample extends React.Component<{}, IShimmerLoadDataExampleState> {
    ...
    componentDidMount() {
        setTimeout(() => this._getContentTwo('ev', true), 2000)
    }
...
*/}
                <Shimmer customElementsGroup={this._getCustomElements()} width={300} isDataLoaded={isDataLoadedTwo}>
                    <Persona {...examplePersona} size={PersonaSize.size100} presence={PersonaPresence.away} />
                </Shimmer>
            </div>
        );
    }
    ...
    private _getContentTwo = (ev: React.MouseEvent<HTMLElement> | string, checked?: boolean): void => {
